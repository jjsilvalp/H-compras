...
$hook_array['before_save'][] = Array(4, 'actualizapp', 'custom/modules/SCO_Productos/Productos.php','Productos', 'FnActualizaPP');
...
$hook_array['after_relationship_delete'][] = Array(2, 'Deactualizapp', 'custom/modules/SCO_Productos/Productos.php','Productos', 'FnActualizaPP');
?>