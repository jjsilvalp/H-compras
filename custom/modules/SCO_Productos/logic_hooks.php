...
$hook_array['before_save'][] = Array(3, 'actualizapp', 'custom/modules/SCO_Productos/ActualizaPP.php','ClActualizaPP', 'FnActualizaPP');
//$hook_array['before_save'][] = Array(3, 'actualizapp', 'custom/modules/SCO_Productos/ActualizaProd.php','Clprodedit', 'Fnprodedit');
